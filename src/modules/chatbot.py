...
class Chatbot:
    ...
    qa_template = """
        ...
        If you still can't the answer, politely respond that you are tuned to only answer questions that are related to the context.
    ...
    def conversational_chat(self, query):
        ...
        result_docs = result['source_documents']
        metaDataList = []
        ...
        result_and_source = f"{result['answer']} \n\n Sources: {metaDataList}"
        return result_and_source
