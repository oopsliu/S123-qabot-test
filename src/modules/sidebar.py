...
class Sidebar:
    ...
    @staticmethod
    def about():
        about = st.sidebar.expander("🧠 About Beiyan ")
        sections = [
            "#### Beiyan is an AI chatbot with a conversational memory, designed to allow users to discuss their data in a more intuitive way. 📄",
